...
class TestReceiptProcessingService(unittest.TestCase):
    ...
    def test_description_multiple(self):
        ...
        first_items = [Item(**item) for item in first_items]
        self.assertEqual(receipt_processing_service.description_multiple(first_items), 6)
        ...
        second_items = [Item(**item) for item in second_items]
        self.assertEqual(receipt_processing_service.description_multiple(second_items), 0)
    ...
    def test_calculate_points(self):
        ...
        self.assertEqual(receipt_processing_service.calculate_points(second_receipt), 109)